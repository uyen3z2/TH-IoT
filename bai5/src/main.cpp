    ...
    { 
      ...
      { 
        ...
        { 
          ...
          { 
            // HTTP headers luôn luôn bắt đầu với code HTTP 
         // ví dụ HTTP/1.1 200 OK) 
            webClient.println("HTTP/1.1 200 OK"); 
            webClient.println("Content-type:text/html");  
 
    // sau đó là kiểu nội dụng mà client gửi tới, ví dụ này là html 
            webClient.println("Connection: close");  
    // kiểu kết nối ở đây là close.  
    // Nghĩa là không giữ kết nối sau khi nhận bản tin 
            webClient.println();  
            ...
            //thêm font-awesome  
            webClient.println("<link rel=\"stylesheet\" href=\"https://cdnjs.cloudflare.com/ajax/libs/font-awesome/4.7.0/css/fontawesome.min.css\">");           
            ...
            webClient.println("<i class=\"fa fa-home\" ariahidden=\"true\"></i>");  
        ...
        else if (c != '\r')   //nếu giá trị gửi tới khác xuống dòng 
        { 
